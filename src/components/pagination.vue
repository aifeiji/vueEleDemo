<template>
    <div class="pagination">
        ...
        <div class="right">
            ...
            <div class="page-btn">
                <el-button :disabled="currentPageInner === 1 || total === 0" @click="currentChange('goFirst')"><i class="iconfont icon-page_first"></i></el-button>
                ...
                <el-button :disabled="currentPageInner === totalPage || total === 0" @click="currentChange('goEnd')"><i class="iconfont icon-page_last"></i></el-button>
            </div>
            <div class="jumper">
                <span>跳至</span>
                ...
                <el-button type="success" :disabled="currentPageInner === jumpIndex || total === 0" @click="currentChange('jumpTo')">跳转</el-button>
            </div>
        </div>
    </div>
</template>
